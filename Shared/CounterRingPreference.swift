...
/// Per-counter history per-period picker value. `default` inherits the app-wide setting.
nonisolated enum HistoryPerPeriodChoice: String, Codable, CaseIterable, Identifiable, Hashable {
  case `default`
  case on
  case off
